...
export function AuthFormSplitScreen({
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col md:flex-row">
      {/* Left Panel: Form */}
      <div className="flex w-full flex-col items-center justify-center bg-[#0e0918] p-8 md:w-1/2">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-left">
              <h1 className="text-[24px] font-medium text-foreground tracking-[-0.02em]">{title}</h1>
            ...
            <motion.p
              variants={itemVariants}
              className="px-8 text-center text-[13px] text-muted-foreground"
            >
              Não tem conta?{" "}
              <a
