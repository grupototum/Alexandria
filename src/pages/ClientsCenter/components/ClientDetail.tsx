...
export function ClientDetail({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-[#0e0918] border-[#1f192a] text-foreground">
        <DialogHeader>
          <div className="flex items-start gap-4 mb-4">
            <div
              className="w-16 h-16 rounded-xl border border-[#1f192a] flex items-center justify-center text-2xl font-bold shrink-0"
              style={{
            ...
            <div className="flex-1">
              <DialogTitle className="text-[20px] font-medium text-foreground">
                {client.company_name}
              </DialogTitle>
